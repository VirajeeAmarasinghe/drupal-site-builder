...
/**
 * Access controller for the ContentEntityExample entity
 * 
 ...
 */
 ...
 class TermAccessControlHandler extends EntityAccessControlHandler{
      ...
      * checkAccess is called with the $operation as defined in the routing.yml file.
      */
      ...
      /**
       * {@inheritdoc}
       * Seperate from the checkAccess because the entity does not yet exist, it will be created during the 'add' process
       */
