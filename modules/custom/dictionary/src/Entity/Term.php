 ...
 *  },
 *  field_ui_base_route = "entity.dictionary_term.term_settings",
 * )
 */
class Term extends ContentEntityBase{ 
     ...
     * {@inheritdoc}
     * 
     * When a new entity instance is added, set the user_id entity reference to the current user 
     * as the creator of the instance
     */
     ...
     * 
     * The behavior of the widgets used can be determined here.
     */
    public static function baseFieldDefinitions(EntityTypeInterface $entity_type){
        ...
        // Users with correct priviledges can change the view and edit configuration.
        ...
        // The for presents a auto complete field for the user name.
