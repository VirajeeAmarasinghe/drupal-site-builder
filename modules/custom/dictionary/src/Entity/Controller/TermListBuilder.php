...
class TermListBuilder extends EntityListBuilder{
    ...
    /**
     * Constructs a new TermListBuilder object
     ...
     * using our buildHeader() & buildRow() implementations.
     */
    public function render(){
        $build['description'] = array(
            ...
            array(
                '@adminlink' => $this->urlGenerator->generateFromRoute('entity.dictionary_term.term_settings')
            ))
        );
